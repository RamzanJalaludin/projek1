...
<head>
	...
	<title>Welcome to StudifyRoom!</title>
...
<body>
	...
	<div id="background">
		...
		<div id="loginContainer">
			...
			<div id="loginText">
				<h1>Listen to your favourite study music, right now</h1>
				<ul>
					<li>Focus on doing your task</li>
					<li>Create your own playlists</li>
					<li>Discover new genres of instrumental musics</li>
				</ul>
			</div>
